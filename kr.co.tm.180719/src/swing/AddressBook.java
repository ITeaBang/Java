...
public class AddressBook extends JFrame {
	...
	// 데이터 배열
	String[][] data = { { "홍길동", "01012345678", "경기도 부천시 도당동" }, { "임꺽정", "01012569382", "경기도 부천시 춘의동" },
			{ "이몽룡", "01098765432", "경기도 부천시 원미동" }, { "성춘향", "01067382915", "경기도 부천시 범박동" } };
	...
	public AddressBook() {
		...
		ActionListener insertListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (name.length() == 0) {
					JOptionPane.showMessageDialog(null, "이름은 필수 입력 사항입니다.", "경고!", JOptionPane.WARNING_MESSAGE);
				...
				// 메시지 박스 출력
				JOptionPane.showMessageDialog(null, "데이터 삽입 성공!", "성공!", JOptionPane.PLAIN_MESSAGE);
		...
		ActionListener deleteListener = new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				model.removeRow(idx);
				table.updateUI();
				JOptionPane.showMessageDialog(null, "데이터 삭제 성공!", "성공!", JOptionPane.WARNING_MESSAGE);
			}
		};
